      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <Progress 
              value={Math.min(roiResults.roiPercentage, 100)} 
              className="mt-2"
            />
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">{roiResults.dailyGeneration.toFixed(2)} kWh/day</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground">Monthly Generation</span>
                <span className="font-medium">{roiResults.monthlyGeneration.toFixed(2)} kWh</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground">Monthly Savings</span>
                <span className="font-medium text-green-600">RM{roiResults.monthlySavings.toFixed(2)}</span>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">RM{systemCost.toLocaleString()}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground">Annual Savings</span>
                <span className="font-medium text-green-600">RM{roiResults.annualSavings.toLocaleString()}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground">Payback Period</span>
                <span className="font-medium">{roiResults.paybackPeriod.toFixed(1)} years</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground">ROI per Year</span>
                <span className="font-medium" style={{ color: getROIColor(roiResults.roiPercentage) }}>
                  {roiResults.roiPercentage.toFixed(1)}%
                </span>
              </div>
              <div className="flex justify-between text-sm pt-2 border-t">
                <span className="text-muted-foreground">Net Profit ({lifetimeYears} years)</span>
                <span className="font-bold text-green-600">
                  RM{((roiResults.annualSavings * lifetimeYears) - systemCost).toLocaleString()}
                </span>
              </div>
            </div>
          </CardContent>
