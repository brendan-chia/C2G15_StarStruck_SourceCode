...
export default function ROICalculator() {
  ...
  const [inputs, setInputs] = useState({
    ...
    shadingFactor: "0.9", // 90% unshaded (10% shading)
  ...
  const handleCalculate = () => {
    const parsedInputs = {
      ...
      shadingFactor: parseFloat(inputs.shadingFactor) || 0,
    ...
    if (parsedInputs.shadingFactor > 1) {
      alert("Shading factor should be a decimal (e.g., 0.9 for 90% unshaded)")
      return
    }
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="space-y-2">
                <label htmlFor="shadingFactor" className="text-sm font-medium">
                  Shading Factor (decimal) *
                </label>
                <Input
                  id="shadingFactor"
                  type="number"
                ...
                />
                <p className="text-xs text-muted-foreground">
                  e.g., 0.9 for 90% unshaded (10% shading)
                </p>
              </div>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                  ...
                  <li>
                    <strong>Shading Factor:</strong> Percentage of roof that is unshaded (0.9 = 90% unshaded, 10% shaded)
                  </li>
                  <li>
